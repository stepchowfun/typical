...
export default function run(): void {
  assertRoundTrip(Foo.size, Foo.serialize, Foo.deserialize, {
    ...
    tRequired: [[], [0.0], [0.0, Math.PI], [0.0, Math.PI, Number.EPSILON], f64TestValues],
    uRequired: [[], [u64Min], [u64Min, 256n], [u64Min, 256n, u64Max], u64TestValues],
    vRequired: [[], [s64Min], [s64Min, 0n], [s64Min, 0n, s64Max], s64TestValues],
    ...
    tAsymmetric: [[], [0.0], [0.0, Math.PI], [0.0, Math.PI, Number.EPSILON], f64TestValues],
    uAsymmetric: [[], [u64Min], [u64Min, 256n], [u64Min, 256n, u64Max], u64TestValues],
    vAsymmetric: [[], [s64Min], [s64Min, 0n], [s64Min, 0n, s64Max], s64TestValues],
  ...
  assertRoundTrip(Foo.size, Foo.serialize, Foo.deserialize, {
    ...
    tOptional: [[], [0.0], [0.0, Math.PI], [0.0, Math.PI, Number.EPSILON], f64TestValues],
    uOptional: [[], [u64Min], [u64Min, 256n], [u64Min, 256n, u64Max], u64TestValues],
    vOptional: [[], [s64Min], [s64Min, 0n], [s64Min, 0n, s64Max], s64TestValues],
  ...
  assertMatch(
    ...
    {
      $field: 'oAsymmetric',
      oAsymmetric: [new Uint8Array([]).buffer, new Uint8Array([0, 42, 255]).buffer],
      $fallback,
    },
    {
      $field: 'oAsymmetric',
