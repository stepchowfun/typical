...
The code generated for each language has no dependencies. This means, for example, that JavaScript code generated by Typical can run in the browser or with Node.js. The generated code never uses reflection or dynamic code evaluation, so it works in [Content Security Policy](https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP)-restricted environments.
